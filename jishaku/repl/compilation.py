...
Constants, functions and classes related to
classifying, compiling and executing Python code.
...
class AsyncCodeExecutor:  # pylint: disable=too-few-public-methods
    ...
    async def traverse(self, func):
        ...
        The class should be used as an iterator instead of using this method.
        """
